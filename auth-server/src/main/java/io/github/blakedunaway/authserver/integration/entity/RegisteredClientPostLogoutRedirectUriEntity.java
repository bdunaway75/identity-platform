...
@Entity
@Table(
        name = "registered_client_post_logout_redirect_uri",
        uniqueConstraints = @UniqueConstraint(columnNames = {"registered_client_id", "post_logout_redirect_uri"})
)
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class RegisteredClientPostLogoutRedirectUriEntity {
