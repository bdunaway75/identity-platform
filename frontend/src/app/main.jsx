...
/**
 * Adjust styling relative to the device being used to access the page.
 * @returns {null}
 * @constructor
 */
function ViewportObserver() {
    React.useEffect(() => {
        ...
        const updateViewportVars = () => {
            ...
            const bottomBrowserOffset = Math.max(0, Math.round(layoutHeight - (visibleHeight + visibleOffsetTop))
            );
            const effectiveSafeArea = {
                top: detectedSafeArea.top,
                right: detectedSafeArea.right,
                bottom: detectedSafeArea.bottom,
                left: detectedSafeArea.left,
            };
